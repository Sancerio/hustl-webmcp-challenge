...
/// is unreachable offline and errors in demo mode. Ordinary demo mode seeds a
/// small, believable inbox of PENDING proposals so the AI-proposals surface
/// renders richly for screenshots (spec §10):
...
class DemoProposalsRepository
  ...
  DemoProposalsRepository({
    ...
    bool seedInitialProposals = true,
    DemoState? state,
    ...
    DemoTemplateRepository? templateRepository,
       ...
       _details = seedInitialProposals
           ? _seedDetails(DateTime(anchor.year, anchor.month, anchor.day))
